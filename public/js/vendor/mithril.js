Mithril = m = new function app(window) {
    ...
    //todo console.log('m() cell=', JSON.stringify(cell));
		return cell
	}
    ...
    //todo console.log('* in m.render. typeof node=', typeof node, 'node.nodeName=', node ? node.nodeName : '',
    //  'index=', index, 'id=', id, 'cell=', JSON.stringify(cell)); // todo debug
